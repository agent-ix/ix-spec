...
As an agent writing a spec, I want to request an authoring pack for the artifact
and object types involved in the work, so that I can create the right files,
use the right skeletons, and validate the result without repeatedly fetching
template context.
